...
admin.site.register(ExpansionPilot)
admin.site.register(ExpansionShip)
admin.site.register(ExpansionUpgrade)
admin.site.register(Expansion)
admin.site.register(Squad)
admin.site.register(SquadPilot)
admin.site.register(SquadPilotUpgrade)
